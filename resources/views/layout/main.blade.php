...
<body class="w-[428px] mx-auto">
    @yield('content')
    <div class="w-[430px] mx-auto px-5 fixed bottom-0 bg-gray-300 xs:py-1 shadow-lg text-black">
        <a href="">
        <div class="flex items-center gap-5">
            <div class="flex flex-col items-center">
                <img src="/assets/icon/burger.svg" alt="burger" class="h-9">
                <span class="text-xs xs:text-base">Daftar</span>
            </div>
            <a href="/news">
                <div class="flex flex-col items-center">
                    <img src="/assets/icon/berita.svg" alt="burger" class="h-9">
                    <span class="text-xs xs:text-base">Berita</span>
                </div>
            </a>
            {{-- start scan --}}
            <a href="/scan">
                <div class="flex flex-col items-center mx-11 -mt-14 bg-white">
                    ...
                    <span class="text-xs xs:text-base">Scan</span>
                </div>
            </a>
            {{-- end scan --}}
            <a href="/about">
                <div class="flex flex-col items-center">
                    ...
                    <span class="text-xs xs:text-base">Tentang</span>
                </div>
            </a>
            <a href="/store">
                <div class="flex flex-col items-center">
                    <img src="/assets/icon/keranjang.svg" alt="burger" class="h-9">
                    <span class="text-xs xs:text-base">Store</span>
                </div>
            </a>
        </div>
    </div>
